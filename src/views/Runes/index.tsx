...
import { getUniqueRunes } from "@/apiHelper/getUniqueRunes";
            ...
            {runes?.map((rune, index) => (
              ...
              >
                ...
                <td className="px-4 py-4 text-left">{rune.rune_name}</td>
                 <td className="px-4 py-2 text-right">{formatNumber(rune.total_amount / Math.pow(10, rune.rune_divisibility))}</td>
